  ...
  <script>
    ...
    var config = {
        ...
        data: {
            ...
            datasets: [
                <?php
                    $stores = $this->cp_model->getByData('stores','');
                                    ...
                                    data: [
                                        <?php 
                                            $monthi=7;while($monthi >= 1){
                                                ...
                                                $moneyData = $this->cp_model->getByData('transactions',' WHERE (created_at LIKE \'%'.$currentDate.'%\') AND (place_id = '.$store['id'].') AND (state = 0)');
